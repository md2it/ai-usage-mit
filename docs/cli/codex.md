...
## OVERVIEW
- Название провайдера: OpenAI Codex CLI
- Ссылка на официальный сайт: https://openai.com/codex
...
- Windows: нативно в PowerShell или через WSL2; детали на официальной странице Windows setup
- npm: вариант доступен на официальной CLI setup странице как отдельная вкладка
- Homebrew: вариант доступен на официальной CLI setup странице как отдельная вкладка
