...
## OVERVIEW
- Название провайдера: Anthropic Claude Code
- Ссылка на официальный сайт: https://www.anthropic.com/claude-code
...
- Native Install для Windows CMD: `curl -fsSL https://claude.ai/install.cmd -o install.cmd && install.cmd && del install.cmd`
- Homebrew: `brew install --cask claude-code`
- Homebrew latest channel: `brew install --cask claude-code@latest`
- WinGet: `winget install Anthropic.ClaudeCode`
- Linux package managers: apt, dnf, apk (см. официальную страницу setup)
